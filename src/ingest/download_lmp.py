...
Downloads daily CAISO RTM ZONAL LMPs (SP15, NP15, ZP26) and puts a combined
ZIP into HDFS at /data/raw/lmp/YYYY-MM/lmp_YYYY-MM.zip
"""
...
SINGLEZIP = (
    ...
    "&resultformat=6"
).format(nodes=NODES, day="{}")  # leave one placeholder for the date
